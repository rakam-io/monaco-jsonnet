...
const BUNDLED_FILE_HEADER = [
  '/*!-----------------------------------------------------------------------------',
  ' * Copyright (c) Rakam Inc. All rights reserved.',
  ' * monaco-jsonnet version: ' + headerVersion,
  ' * Released under the MIT license',
  ' * https://github.com/rakam-io/monaco-jsonnet/blob/master/LICENSE.md',
  ' *-----------------------------------------------------------------------------*/',
  ''
].join('\n')
...
function bundleOne (moduleId, exclude) {
  requirejs.optimize({
    ...
    exclude: exclude,
    paths: {
      'vs/language/jsonnet': REPO_ROOT + '/out/amd'
    },
    optimize: 'none',
    packages: [{
