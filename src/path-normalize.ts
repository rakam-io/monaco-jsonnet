...
// taken from https://github.com/zacanger/path-normalize/blob/master/src/index.js
// because the library doesn't support umd thus can't be imported from web worker
